...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="username can't empty" ControlToValidate="tbUsername"></asp:RequiredFieldValidator>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="password can't empty" ControlToValidate="tbPassword"></asp:RequiredFieldValidator>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="confirm password can't empty" ControlToValidate="tbConfirmPassword"></asp:RequiredFieldValidator>
        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Harus sama dengan password" ControlToValidate="tbConfirmPassword" ControlToCompare="tbPassword"></asp:CompareValidator>
    </div>
    <div>
        <asp:TextBox ID="tbDOB" placeholder="Date of Birth" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="tbDOB" ErrorMessage="dob can't empty"></asp:RequiredFieldValidator>
    </div>
    <div>
        <asp:Button ID="btnRegister" OnClick="btnRegister_Click" runat="server" Text="Login" />
    </div>
</asp:Content>
